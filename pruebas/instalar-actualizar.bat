...
if "%ruta_actual:~-11%"=="\%carpeta%" (
    echo Estás dentro de la carpeta %carpeta%.
    pause
    rem Coloca aquí el comando que deseas ejecutar si estás dentro de la carpeta .minecraft
) else (
    echo -----------------------------------------------------------------------------------------------------------
    echo   ¡ADVERTENCIA!:
    ...
    if errorlevel 2 (
        ...
        REM Aquí empieza el codigo completo dentro de la validación de la carpeta -------------------------------------
        ...
        REM -----------------------------------------------
            ...
            exit /b
        REM Aquí termina el codigo completo dentro de la validación de la carpeta -------------------------------------
    )
)
